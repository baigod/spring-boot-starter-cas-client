...
/**
 * 改写SingleSignOutFilter
 * 
 * @author luheng
 *
 */
public final class ClusterSingleSignOutFilter extends AbstractConfigurationFilter {
	...
	public void doFilter(final ServletRequest servletRequest, final ServletResponse servletResponse,
		...
		/**
		 * <p>
		 * Workaround for now for the fact that Spring Security will fail since it
		 * doesn't call {@link #init(javax.servlet.FilterConfig)}.
		 * </p>
		 * <p>
		 * Ultimately we need to allow deployers to actually inject their
		 * fully-initialized {@link org.jasig.cas.client.session.SingleSignOutHandler}.
		 * </p>
		 */
